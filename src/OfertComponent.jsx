export default function Ofer_element({ofert}){
    const singup = ()=>{
    ...
    return(
        <div className="flex flex-row h-98 w-96 mx-2  bg-white rounded-2xl  border-solid border-cyan-600 border-3">
            <section className="w-1/2 rounded-l-xl flex flex-col text-center text-wrap px-3">
                <h1 className="text-xl font-medium mt-3 text-cyan-600 font-ubuntu">{ofert.title}</h1>
                <br />
                <h2 className="text-cyan-900 font-ubuntu">{ofert.description}</h2>
                <br />
                <h3 className="mt-10 text-cyan-600 font-ubuntu text-[18px]">{ofert.price}</h3>
